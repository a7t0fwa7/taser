...
def main():
    for url in collect_targets(args.target[0], args.proto, args.port, args.page):
        try:
...
if __name__ == '__main__':
    ...
    args.add_argument("--hide-title", action='store_false', help="Hide title output from CLI, useful to only extract headers.")
    ...
    args.add_argument('--proto', default='http,https', type=lambda x: delimiter2list(x), help='Define protocol (http,https*)')
